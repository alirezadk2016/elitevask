...
var FAQ=[
  ...
  {q:{da:"Hvor lang tid tager vasken?",en:"How long does the wash take?"},a:{da:"Det afhænger af bilstørrelse og pakke:<br>• <strong>Lille bil:</strong> 100–120 min<br>• <strong>Mellemstor bil:</strong> 120–180 min<br>• <strong>Stor bil / SUV:</strong> 150–200 min<br>• <strong>Varebil:</strong> 90–180 min<br>Vi er altid præcise med vores tidsestimater og holder dig opdateret.",en:"It depends on car size and package:<br>• <strong>Small car:</strong> 100–120 min<br>• <strong>Medium car:</strong> 120–180 min<br>• <strong>Large car / SUV:</strong> 150–200 min<br>• <strong>Van:</strong> 90–180 min<br>We always give accurate time estimates and keep you updated."}},
  ...
  {q:{da:"Vasker I undervognen?",en:"Do you clean the underbody?"},a:{da:"Hel vask inkluderer altid en grundig undervognsbehandling. Vi fjerner vejsalt, vejsnavs og gammel fedt fra hjulkasser og underside. Det er særlig vigtigt i vintermånederne, hvor vejsalt kan starte rustprocessen i skjulte områder.",en:"Full wash always includes a thorough underbody treatment. We remove road salt, road grime and old grease from wheel arches and the underside. This is especially important in winter months, when road salt can start the rust process in hidden areas."}},
...
function renderCalc(){
  ...
  PKGS.forEach(function(pk){
    ...
    var goldScene=pk.gold?'<div class="gold-scene" aria-hidden="true"><svg class="gs-svg" viewBox="0 0 250 76" fill="none" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="gsWetGrad" x1="0" y1="0" x2="1" y2="0"><stop offset="0%" stop-color="rgba(55,210,120,0)"/><stop offset="50%" stop-color="rgba(55,210,120,.1)"/><stop offset="100%" stop-color="rgba(55,210,120,0)"/></linearGradient><filter id="gsGlow"><feGaussianBlur stdDeviation="2" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter></defs><!-- CAR GLOW BG --><ellipse cx="55" cy="50" rx="58" ry="16" fill="rgba(212,175,55,.06)"/><!-- CAR: flipped to face RIGHT so robot sprays the front --><g class="gsc-car" transform="translate(4,10) scale(.75) translate(120,0) scale(-1,1)" stroke-linecap="round" stroke-linejoin="round" stroke="#c8a830" stroke-width="2.2">'+selCar.svg+'</g><!-- WET OVERLAY --><rect class="gsc-wet" x="4" y="10" width="90" height="46" rx="4" fill="url(#gsWetGrad)" opacity="0"/><!-- SHINE --><rect class="gsc-shine" x="4" y="10" width="90" height="46" rx="3" fill="rgba(255,248,200,.1)" opacity="0"/><!-- SPARKS --><text class="gsk gsk1" x="22" y="13" font-size="7" fill="#f0d97a" text-anchor="middle" opacity="0">✦</text><text class="gsk gsk2" x="58" y="7" font-size="6" fill="#f0d97a" text-anchor="middle" opacity="0">✦</text><text class="gsk gsk3" x="82" y="16" font-size="5" fill="#f0d97a" text-anchor="middle" opacity="0">✦</text><text class="gsk gsk4" x="42" y="6" font-size="4" fill="#f0d97a" text-anchor="middle" opacity="0">✦</text><!-- SPRAY: from robot nozzle (left side, ~x=155) toward car front (right side, ~x=88) --><g class="gsc-spray"><line class="gsl gsl1" x1="157" y1="33" x2="90" y2="26" stroke="#37d278" stroke-width="1.2" stroke-linecap="round" opacity="0"/><line class="gsl gsl2" x1="157" y1="36" x2="88" y2="36" stroke="#37d278" stroke-width="1.5" stroke-linecap="round" opacity="0"/><line class="gsl gsl3" x1="157" y1="39" x2="90" y2="46" stroke="#37d278" stroke-width="1.2" stroke-linecap="round" opacity="0"/><circle class="gsd gsd1" cx="118" cy="29" r="1.6" fill="#37d278" opacity="0"/><circle class="gsd gsd2" cx="106" cy="36" r="1.3" fill="#37d278" opacity="0"/><circle class="gsd gsd3" cx="114" cy="43" r="1.5" fill="#37d278" opacity="0"/><circle class="gsd gsd4" cx="98" cy="31" r="1.1" fill="rgba(55,210,120,.7)" opacity="0"/><circle class="gsd gsd5" cx="110" cy="42" r="1.3" fill="rgba(55,210,120,.8)" opacity="0"/></g><!-- STEAM --><circle class="gsm gsm1" cx="50" cy="18" r="0" fill="rgba(200,230,255,.08)"/><circle class="gsm gsm2" cx="68" cy="12" r="0" fill="rgba(200,230,255,.06)"/><circle class="gsm gsm3" cx="35" cy="15" r="0" fill="rgba(200,230,255,.07)"/><!-- ROBOT (smaller: scale .72) --><g class="gsr" transform="translate(174,6) scale(.58)"><g class="gsr-float"><g class="gsr-head"><path d="M6 24 Q4 9 31 7 Q58 9 56 24 L56 30 Q56 35 51 35 L11 35 Q6 35 6 30 Z" fill="#0d1117" stroke="#c8a830" stroke-width="1.4"/><rect x="11" y="12" width="40" height="18" rx="5" fill="#050d1a" stroke="#37d278" stroke-width=".9"/><rect x="11" y="12" width="40" height="7" rx="5" fill="rgba(255,255,255,.04)"/><g class="gsr-eyes"><rect x="13" y="15" width="14" height="8" rx="4" fill="#37d278" filter="url(#gsGlow)"/><rect x="13" y="15" width="14" height="8" rx="4" fill="#37d278" opacity=".3" style="filter:blur(3px)"/><rect x="35" y="15" width="14" height="8" rx="4" fill="#37d278" filter="url(#gsGlow)"/><rect x="35" y="15" width="14" height="8" rx="4" fill="#37d278" opacity=".3" style="filter:blur(3px)"/><rect x="17" y="17" width="5" height="4" rx="2" fill="rgba(255,255,255,.25)"/><rect x="39" y="17" width="5" height="4" rx="2" fill="rgba(255,255,255,.25)"/></g><line x1="31" y1="3" x2="31" y2="8" stroke="#c8a830" stroke-width="1.5" stroke-linecap="round"/><circle cx="31" cy="2" r="2.5" fill="#37d278" filter="url(#gsGlow)"/></g><rect x="24" y="34" width="14" height="6" rx="3" fill="#131820" stroke="rgba(200,168,48,.5)" stroke-width=".9"/><rect x="8" y="39" width="46" height="28" rx="8" fill="#0d1117" stroke="#c8a830" stroke-width="1.4"/><rect x="14" y="43" width="34" height="18" rx="4" fill="#050d1a" stroke="rgba(200,168,48,.2)" stroke-width=".7"/><circle class="gsd-chest1" cx="22" cy="52" r="3" fill="#37d278" filter="url(#gsGlow)"/><circle class="gsd-chest2" cx="31" cy="52" r="3" fill="#c8a830"/><circle class="gsd-chest3" cx="40" cy="52" r="3" fill="#37d278" filter="url(#gsGlow)"/><g class="gsr-arm-spray"><circle cx="8" cy="45" r="5" fill="#131820" stroke="#c8a830" stroke-width="1.2"/><path d="M4 43 Q-6 40 -10 36" stroke="#c8a830" stroke-width="4" stroke-linecap="round" fill="none"/><path d="M-10 36 Q-14 34 -16 33" stroke="#c8a830" stroke-width="3" stroke-linecap="round" fill="none"/><rect x="-30" y="28" width="16" height="9" rx="4.5" fill="#131820" stroke="#37d278" stroke-width="1.2"/><path d="M-30 29.5 L-36 33 L-30 36.5 Z" fill="#37d278"/></g><g class="gsr-arm-r"><circle cx="54" cy="45" r="5" fill="#131820" stroke="#c8a830" stroke-width="1.2"/><path d="M58 44 Q65 46 68 54" stroke="#c8a830" stroke-width="4" stroke-linecap="round" fill="none"/><rect x="63" y="53" width="11" height="9" rx="3.5" fill="#131820" stroke="#c8a830" stroke-width="1.1"/><rect x="65" y="47" width="7" height="8" rx="3.5" fill="#131820" stroke="#c8a830" stroke-width="1.1"/></g><rect x="17" y="66" width="12" height="5" rx="2.5" fill="#131820" stroke="#c8a830" stroke-width="1"/><rect x="33" y="66" width="12" height="5" rx="2.5" fill="#131820" stroke="#c8a830" stroke-width="1"/><rect x="12" y="70" width="18" height="6" rx="3" fill="#0d1117" stroke="#c8a830" stroke-width="1.1"/><rect x="32" y="70" width="18" height="6" rx="3" fill="#0d1117" stroke="#c8a830" stroke-width="1.1"/></g></g></svg></div>':'';
