...
function renderCalc(){
  ...
  PKGS.forEach(function(pk){
    ...
    var goldScene=pk.gold?'<div class="gold-scene" aria-hidden="true"><svg class="gs-svg" viewBox="0 0 260 88" fill="none" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="gsWetGrad" x1="0" y1="0" x2="1" y2="0"><stop offset="0%" stop-color="rgba(55,210,120,0)"/><stop offset="50%" stop-color="rgba(55,210,120,.12)"/><stop offset="100%" stop-color="rgba(55,210,120,0)"/></linearGradient><filter id="gsGlow"><feGaussianBlur stdDeviation="2" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter></defs><!-- CAR --><g class="gsc-car" transform="translate(4,14) scale(.75)" stroke-linecap="round" stroke-linejoin="round">'+selCar.svg+'<rect class="gsc-wet" x="0" y="0" width="120" height="60" rx="4" fill="url(#gsWetGrad)" opacity="0"/></g><!-- SHINE --><rect class="gsc-shine" x="4" y="14" width="90" height="45" rx="3" fill="rgba(255,245,200,.12)" opacity="0"/><!-- SPARKS --><text class="gsk gsk1" x="18" y="16" font-size="8" fill="#f0d97a" text-anchor="middle" opacity="0">✦</text><text class="gsk gsk2" x="62" y="10" font-size="7" fill="#f0d97a" text-anchor="middle" opacity="0">✦</text><text class="gsk gsk3" x="88" y="20" font-size="6" fill="#f0d97a" text-anchor="middle" opacity="0">✦</text><text class="gsk gsk4" x="40" y="8" font-size="5" fill="#f0d97a" text-anchor="middle" opacity="0">✦</text><!-- SPRAY LINES --><g class="gsc-spray"><line class="gsl gsl1" x1="173" y1="38" x2="100" y2="32" stroke="#37d278" stroke-width="1.2" stroke-linecap="round" opacity="0"/><line class="gsl gsl2" x1="173" y1="40" x2="98" y2="40" stroke="#37d278" stroke-width="1.5" stroke-linecap="round" opacity="0"/><line class="gsl gsl3" x1="173" y1="42" x2="100" y2="48" stroke="#37d278" stroke-width="1.2" stroke-linecap="round" opacity="0"/><circle class="gsd gsd1" cx="130" cy="34" r="1.8" fill="#37d278" opacity="0"/><circle class="gsd gsd2" cx="115" cy="40" r="1.4" fill="#37d278" opacity="0"/><circle class="gsd gsd3" cx="125" cy="46" r="1.6" fill="#37d278" opacity="0"/><circle class="gsd gsd4" cx="108" cy="36" r="1.2" fill="rgba(55,210,120,.7)" opacity="0"/><circle class="gsd gsd5" cx="120" cy="44" r="1.4" fill="rgba(55,210,120,.8)" opacity="0"/></g><!-- STEAM PUFFS --><circle class="gsm gsm1" cx="55" cy="22" r="0" fill="rgba(200,230,255,.08)"/><circle class="gsm gsm2" cx="72" cy="16" r="0" fill="rgba(200,230,255,.06)"/><circle class="gsm gsm3" cx="38" cy="18" r="0" fill="rgba(200,230,255,.07)"/><!-- ROBOT --><g class="gsr" transform="translate(178,4)"><g class="gsr-float"><!-- HEAD --><g class="gsr-head"><path d="M6 24 Q4 9 31 7 Q58 9 56 24 L56 30 Q56 35 51 35 L11 35 Q6 35 6 30 Z" fill="#0d1117" stroke="#c8a830" stroke-width="1.4"/><rect x="11" y="12" width="40" height="18" rx="5" fill="#050d1a" stroke="#37d278" stroke-width=".9"/><rect x="11" y="12" width="40" height="7" rx="5" fill="rgba(255,255,255,.04)"/><g class="gsr-eyes"><rect x="13" y="15" width="14" height="8" rx="4" fill="#37d278" filter="url(#gsGlow)"/><rect x="13" y="15" width="14" height="8" rx="4" fill="#37d278" opacity=".3" style="filter:blur(3px)"/><rect x="35" y="15" width="14" height="8" rx="4" fill="#37d278" filter="url(#gsGlow)"/><rect x="35" y="15" width="14" height="8" rx="4" fill="#37d278" opacity=".3" style="filter:blur(3px)"/><rect x="17" y="17" width="5" height="4" rx="2" fill="rgba(255,255,255,.25)"/><rect x="39" y="17" width="5" height="4" rx="2" fill="rgba(255,255,255,.25)"/></g><line x1="31" y1="3" x2="31" y2="8" stroke="#c8a830" stroke-width="1.5" stroke-linecap="round"/><circle cx="31" cy="2" r="2.5" fill="#37d278" filter="url(#gsGlow)"/></g><!-- NECK --><rect x="24" y="34" width="14" height="6" rx="3" fill="#131820" stroke="rgba(200,168,48,.5)" stroke-width=".9"/><!-- TORSO --><rect x="8" y="39" width="46" height="28" rx="8" fill="#0d1117" stroke="#c8a830" stroke-width="1.4"/><rect x="14" y="43" width="34" height="18" rx="4" fill="#050d1a" stroke="rgba(200,168,48,.2)" stroke-width=".7"/><circle class="gsd-chest1" cx="22" cy="52" r="3" fill="#37d278" filter="url(#gsGlow)"/><circle class="gsd-chest2" cx="31" cy="52" r="3" fill="#c8a830"/><circle class="gsd-chest3" cx="40" cy="52" r="3" fill="#37d278" filter="url(#gsGlow)"/><!-- SPRAY ARM --><g class="gsr-arm-spray"><circle cx="8" cy="45" r="5" fill="#131820" stroke="#c8a830" stroke-width="1.2"/><path d="M4 43 Q-6 40 -10 36" stroke="#c8a830" stroke-width="4" stroke-linecap="round" fill="none"/><path d="M-10 36 Q-14 34 -16 33" stroke="#c8a830" stroke-width="3" stroke-linecap="round" fill="none"/><rect x="-30" y="28" width="16" height="9" rx="4.5" fill="#131820" stroke="#37d278" stroke-width="1.2"/><path d="M-30 29.5 L-36 33 L-30 36.5 Z" fill="#37d278"/></g><!-- FREE ARM --><g class="gsr-arm-r"><circle cx="54" cy="45" r="5" fill="#131820" stroke="#c8a830" stroke-width="1.2"/><path d="M58 44 Q65 46 68 54" stroke="#c8a830" stroke-width="4" stroke-linecap="round" fill="none"/><rect x="63" y="53" width="11" height="9" rx="3.5" fill="#131820" stroke="#c8a830" stroke-width="1.1"/><rect x="65" y="47" width="7" height="8" rx="3.5" fill="#131820" stroke="#c8a830" stroke-width="1.1"/></g><!-- LEGS --><rect x="17" y="66" width="12" height="5" rx="2.5" fill="#131820" stroke="#c8a830" stroke-width="1"/><rect x="33" y="66" width="12" height="5" rx="2.5" fill="#131820" stroke="#c8a830" stroke-width="1"/><!-- FEET --><rect x="12" y="70" width="18" height="6" rx="3" fill="#0d1117" stroke="#c8a830" stroke-width="1.1"/><rect x="32" y="70" width="18" height="6" rx="3" fill="#0d1117" stroke="#c8a830" stroke-width="1.1"/></g></g></svg></div>':'';
