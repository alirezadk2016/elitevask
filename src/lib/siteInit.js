...
function renderCalc(){
  ...
  PKGS.forEach(function(pk){
    ...
    var goldScene=pk.gold?'<div class="gold-scene" aria-hidden="true"><div class="gs-stage"><svg class="gs-car" viewBox="0 0 120 60" fill="none" stroke="rgba(212,175,55,.55)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">'+selCar.svg+'</svg><div class="gs-shine"></div><div class="gs-sparks"><span>✦</span><span>✦</span><span>✦</span><span>✦</span></div></div><div class="gs-robot"><svg viewBox="0 0 44 56" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="10" y="18" width="24" height="22" rx="5" fill="#1a1a2e" stroke="rgba(212,175,55,.6)" stroke-width="1.5"/><rect x="14" y="8" width="16" height="14" rx="7" fill="#1a1a2e" stroke="rgba(212,175,55,.6)" stroke-width="1.5"/><circle cx="19" cy="14" r="2.5" fill="#37d278" opacity=".9"/><circle cx="25" cy="14" r="2.5" fill="#37d278" opacity=".9"/><line x1="10" y1="26" x2="3" y2="32" stroke="rgba(212,175,55,.5)" stroke-width="2" stroke-linecap="round"/><line x1="34" y1="26" x2="41" y2="22" stroke="rgba(212,175,55,.5)" stroke-width="2" stroke-linecap="round"/><rect x="38" y="19" width="8" height="4" rx="2" fill="#37d278" opacity=".7"/><line x1="10" y1="38" x2="6" y2="48" stroke="rgba(212,175,55,.5)" stroke-width="2" stroke-linecap="round"/><line x1="34" y1="38" x2="38" y2="48" stroke="rgba(212,175,55,.5)" stroke-width="2" stroke-linecap="round"/></svg><div class="gs-spray"><span></span><span></span><span></span><span></span><span></span></div></div></div>':'';
