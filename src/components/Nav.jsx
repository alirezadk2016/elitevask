...
<nav class="nav" id="siteNav"><div class="nav-inner">
  ...
  <div class="nav-right">
    ...
    <a href="https://dk.trustpilot.com/review/elite-vask.dk" target="_blank" rel="noopener" class="nav-tp" aria-label="Se vores anmeldelser på Trustpilot" title="Trustpilot">
      <svg viewBox="0 0 24 24" width="14" height="14" aria-hidden="true"><path fill="#00b67a" d="M12 2l2.9 6.95L22 9.6l-5.3 4.7 1.6 7.1L12 17.6 5.7 21.4l1.6-7.1L2 9.6l7.1-.65L12 2z"/></svg>
      <span class="nav-tp-stars" aria-hidden="true"><i></i><i></i><i></i><i></i><i></i></span>
    </a>
