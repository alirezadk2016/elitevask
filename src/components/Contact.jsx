  ...
  <div class="contact-grid">
    <div>
      ...
      <div class="contact-cta">
        <button class="btn btn-green btn-lg" data-book data-i18n="ct_book">Book online nu</button>
