    ...
    <div class="steam-facts">
      ...
      <div class="steam-fact">
        ...
        <div class="steam-fact-body">
          ...
          <p data-i18n="steam_f2p">Damp renser ikke bare overfladen — den trænger ind og løsner snavs fra dybden. Resultatet er en levende, skinnende glans som fremhæver bilens originale farve og får den til at fremstå som ny.</p>
        </div>
      </div>
      <div class="steam-fact">
        ...
        <div class="steam-fact-body">
          ...
          <p data-i18n="steam_f3p">Højtryk og aggressive kemikalier påfører lakken usynlige mikroskopiske ridser ved hvert vask. Dampvask renser intenst og skånsomt uden kemikalier — og beskytter dermed din bils lak og værdi på lang sigt.</p>
        </div>
      </div>
    </div>
  </div>
