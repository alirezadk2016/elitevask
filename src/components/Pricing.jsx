...
<section class="sec selector" id="vaelg"><div class="wrap">
  <div class="center">
    ...
    <h2 class="sec-title" data-i18n="sel_title">Vælg din biltype</h2>
    <p class="sec-sub" data-i18n="sel_sub">Find din bil herunder, så viser vi prisen med det samme – inkl. kørsel.</p>
  </div>
