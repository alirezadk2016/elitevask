...
export const metadata = {
  ...
  keywords: ["mobil bilvask","mobil bilpleje","bilvask hjemme","bilrengøring hjemme","mobil dampvask","bilvask Sjælland","bilpleje København","mobil bilvask hjemme hos dig"],
