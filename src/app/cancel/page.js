    ...
    <div className="legal-page">
      <div className="legal-wrap">
        ...
        {state === "busy" && (
          <div className="cancel-card cancel-invalid">
            <div className="cancel-icon">⏳</div>
            <h1>{da ? "Behandles allerede" : "Already processing"}</h1>
            <p>{da
              ? "Din annullering er allerede i gang. Vent et øjeblik og opdater siden for at se status."
              : "Your cancellation is already being processed. Wait a moment and refresh the page to see the status."
            }</p>
          </div>
        )}
